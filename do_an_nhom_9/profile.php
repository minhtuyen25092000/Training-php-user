...
<form action="" method="post">
    ...
    <div class="row">
        <div class="col-md-12">
            <label>Địa Chỉ:1096 KHA VẠN CÂN <span class="error"> *</span></label>
